...
/// <see cref="ApiException"/> con un mensaje legible. Copia casi literal de
/// Inventario.Desktop.Services.Http.ApiServiceBase — la única diferencia real entre ambos clientes
/// es de dónde sale el JWT (SecureStorage allá, la cookie de sesión aquí vía AuthHeaderHandler).
/// </summary>
